              ...
              <div className="md:w-9/10 lg:w-8/10 mx-auto relative">
                ...
                <div className="md:flex md:mr-5 md:ml-3">
                  ...
                  <div className="md:w-1/2">
                    ...
                    <div className="project-description text-default-gray text-base md:text-lg leading-7 mb-8 text-center md:text-left">
                ...
                <div className="mockups relative md:flex">
                  <img
                    ...
                    alt="Mockups on mobile phone"
                    className="md:absolute top-20 -left-56"
                  />
                  <img
                    src={project.mockups.tablet}
                    alt="Mockups on tablet"
                    className="md:absolute right-32 -top-22"
                  />
                </div>
              </div>
            </div>
                  ...
                  <div className="md:w-1/2">
                    {project.challenges.map((challenge, index) => (
                      <>
                        ...
                        <p className="text-default-gray text-base md:text-lg leading-7 mt-4 mb-9 ml-7.5">
                ...
                <div className="md:flex justify-between mb-16">
                  <div className="md:w-2.7/10 md:mb-0 mb-10">
                    <div className="border-solid border-r-2 border-r-gray pr-2">
                      <p className="text-2xl text-grayish-blue text-left mb-6">
                        Font Family
                      </p>
                      <p className="text-3.5xl text-grayish-blue text-left font-extrabold">
                        Avenir Font Family
                      </p>
                    </div>
                  </div>
                  <div className="md:w-5/10 flex items-center space-x-10">
                    <div>
                      <p className="text-8xl font-extrabold text-grayish-blue text-left">
                        Aa
                      </p>
                    </div>
                ...
                <div className="md:flex justify-between">
                  ...
                  <div className="md:w-5/10 flex items-center space-x-9 md:mb-0 mb-10">
                    {project.colors.map((color, index) => (
                      <div className="px-2.5 py-3 bg-white color-card">
                        <div
                          className={`h-8 w-38 rounded-md mb-5 bg-${
                            color.alias + project.id
                          }`}
                        >
                          {' '}
                        </div>
                        <p className="text-xs font-bold text-black text-left mb-1">
                          {color.name}
                        </p>
