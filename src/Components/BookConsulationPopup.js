                    ...
                    <div>
                        ...
                        <div className='md:flex justify-between'>
                            <div className='md:w-5/10 relative bg-neutral-100 py-8'>
                                <PolygonGroup />
                                <img src={Clock} alt="Book session" className="absolute left-24 top-25"/>
                            </div>
                            <div className='md:w-4/10 mr-11'>
                                ...
                                <form>
                                    <div className="mb-4">
                                        <label htmlFor="subject-field" className="text-xs mb-1 font-semibold">Select Service</label>
                                        <select 
                                            id= "service"
                                            name="service" 
                                        ...
                                        {errors.service && touched.service && <span className="text-xs text-red-600">{errors.service}</span>}
                                    </div>
                                    <div className='mb-4'>
                                        <label htmlFor="subject-field" className="text-xs mb-1 font-semibold">
                                        Subject
                                        </label>
                                        <input
                                        id="subject-field"
                                    ...
                                    <div>
                                        <label htmlFor="message-field" className="text-xs mb-1 font-semibold">
                                        Subject
                                        </label>
                                        <textarea
                                            name="message"
                                    ...
                                    <div className='flex justify-between items-center'>
                                        <button className='py-2.5 flex items-center border border-neutral-600 rounded-md pl-5 pr-10 text-neutral-600 text-sm font-semibold'><span className='mr-5'><AngleArrowLeft /> </span>Previous</button>
                                        <button className='bg-blue-400 px-14 py-2.5 rounded-md ml-6'>Send</button>
                                    </div>
                                </form>)}
                                </Formik>
                            </div>
