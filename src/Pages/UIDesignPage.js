  ...
  return (
    <div
      className={`md:flex w-full ${
        colors[index % 3]
      } mb-10 md:pt-28 py-12 rounded-2xl`}
    >
      ...
      <div className="md:w-1/2 md:pl-13 px-6 md:pr-24">
        ...
        <div className="text-black text-base md:text-lg leading-7 mb-8 text-center md:text-left">
          {summary.split('\n').map((i, key) => {
  ...
  const projects = [
    {
      ...
      summary:
        'Quantum Clinic was conceived as a spa to not just for your body but also for your DNA',
      screenshot: Project1,
    },
    {
